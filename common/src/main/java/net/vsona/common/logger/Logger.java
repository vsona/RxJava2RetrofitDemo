...
public class Logger {
    ...
    public static boolean isShowLog = CommonConstants.isShowLog;
    private static final String DEFAULT_TAG = CommonConstants.Logger.DefaultLogTag;
